...
const gitApi = {
  ...
  pushTag: (repoPath: string, name: string) => ipcRenderer.invoke('git:pushTag', repoPath, name),
  ...
  applyPatch: (repoPath: string, patchContent: string, reverse: boolean) => ipcRenderer.invoke('git:applyPatch', repoPath, patchContent, reverse),
  diffHunks: (repoPath: string, filePath: string, staged: boolean) => ipcRenderer.invoke('git:diffHunks', repoPath, filePath, staged),
